    ...
    <footer className="bg-card border-t border-border mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-4">
              Celebrating India's rich craft heritage through immersive storytelling and connecting artisans with the world.
            </p>
            <div className="space-y-2 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4" />
                <span>hello@culturecart.in</span>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="mt-8 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} CultureCart. Preserving traditions, empowering artisans.</p>
        </div>
      </div>
    </footer>
  );
